...
haste.prototype.newDocument = function (hideHistory) {
  ...
  if (!hideHistory) {
    window.history.pushState(null, this.appName, '/hastebin/');
  }
  this.setTitle();
  this.lightKey();
...
haste.prototype.configureButtons = function () {
  ...
  this.buttons = [
    ...
    },
    {
      ...
      action: function () {
        window.location.href = '/hastebin/raw/' + _this.doc.key;
      }
    },
    {
      $where: $('#box2 .twitter'),
